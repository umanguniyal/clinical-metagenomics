...
rule nanopore_coverage_and_mode:
    ...
    log:
        os.path.join(RESULTS_DIR, "nanopore", "{sample}", "logs", "nanopore_coverage_and_mode.log")
    benchmark:
        os.path.join(RESULTS_DIR, "nanopore", "{sample}", "benchmarks", "nanopore_coverage_and_mode.txt")
    conda:
