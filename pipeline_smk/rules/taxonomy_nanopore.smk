...
rule nanopore_kraken2:
    ...
    log:
        os.path.join(RESULTS_DIR, "nanopore", "{sample}", "logs", "nanopore_kraken2.log")
    benchmark:
        os.path.join(RESULTS_DIR, "nanopore", "{sample}", "benchmarks", "nanopore_kraken2.txt")
    conda:
...
rule nanopore_tb_flag:
    ...
    log:
        os.path.join(RESULTS_DIR, "nanopore", "{sample}", "logs", "nanopore_tb_flag.log")
    benchmark:
        os.path.join(RESULTS_DIR, "nanopore", "{sample}", "benchmarks", "nanopore_tb_flag.txt")
    shell:
        r"""
...
rule nanopore_tbprofiler:
    ...
    log:
        os.path.join(RESULTS_DIR, "nanopore", "{sample}", "logs", "nanopore_tbprofiler.log")
    benchmark:
        os.path.join(RESULTS_DIR, "nanopore", "{sample}", "benchmarks", "nanopore_tbprofiler.txt")
    conda:
...
rule nanopore_centrifuge:
    ...
    log:
        os.path.join(RESULTS_DIR, "nanopore", "{sample}", "logs", "nanopore_centrifuge.log")
    benchmark:
        os.path.join(RESULTS_DIR, "nanopore", "{sample}", "benchmarks", "nanopore_centrifuge.txt")
    conda:
...
rule nanopore_krona_kraken2:
    ...
    log:
        os.path.join(RESULTS_DIR, "nanopore", "{sample}", "logs", "nanopore_krona_kraken2.log")
    benchmark:
        os.path.join(RESULTS_DIR, "nanopore", "{sample}", "benchmarks", "nanopore_krona_kraken2.txt")
    conda:
...
rule nanopore_krona_centrifuge:
    ...
    log:
        os.path.join(RESULTS_DIR, "nanopore", "{sample}", "logs", "nanopore_krona_centrifuge.log")
    benchmark:
        os.path.join(RESULTS_DIR, "nanopore", "{sample}", "benchmarks", "nanopore_krona_centrifuge.txt")
    conda:
        os.path.join(ENVS_DIR, "krona.yaml")
    shell:
        r"""
