...
rule illumina_coverage_and_mode:
    ...
    log:
        os.path.join(RESULTS_DIR, "illumina", "{sample}", "logs", "illumina_coverage_and_mode.log")
    benchmark:
        os.path.join(RESULTS_DIR, "illumina", "{sample}", "benchmarks", "illumina_coverage_and_mode.txt")
    conda:
