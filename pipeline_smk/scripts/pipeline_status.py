...
def main():
    ...
    for platform in ["illumina", "nanopore"]:
        ...
        for sample in os.listdir(platform_dir):
            ...
            assembly = check_milestone(sample_dir, "assembly/contigs.fasta")
            coverage = check_milestone(sample_dir, "qc/mean_coverage.txt")
            amr = check_milestone(sample_dir, "amr/abricate_card.tsv")
            binning = check_milestone(sample_dir, "bin_annotations/prokka_stats.json")
